...
public class CalendarService {
  ...
  public List<Calendar> getData(String month, String team) throws IOException {
    ...
    String URL = "https://sports.news.naver.com/kbaseball/schedule/index?date=20230601&month=0" + month
        + "&year=2023&teamCode=" + team;
    ...
    public List<Calendar> gettData(String month, String team) throws IOException {
